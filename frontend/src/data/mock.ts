...
export const recentMissions = [
  { icon: 'building', color: 'blue', name: 'Construction Leads – Lyon', updated: 'Updated 1h ago', progress: 65, leads: 148 },
  { icon: 'leaf', color: 'green', name: 'Investors for Food Startup', updated: 'Updated 2h ago', progress: 40, leads: 86 },
  { icon: 'sushi', color: 'orange', name: 'New Suppliers for Sushi Business', updated: 'Updated 5h ago', progress: 25, leads: 63 },
] as const;
